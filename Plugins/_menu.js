...
╰━━━━━━━━━━━━━>\n ${readMore}\n\n`;
                        ...
                        commands.map((command, num) => {
                            if (command.name) {
                                ...
                                Sparky = NickName.source.split('\\s*')[1].toString().match(/(\W*)([A-Za-züşiğ öç1234567890]*)/)[2];
                            }
...
┠┌─⭓『 *${cmmd.toUpperCase()}* 』\n`;
         ...
         return await client.sendMessage(m.jid, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://nick.devstackx.in",
                            mediaType: 1,
         ...
         return await client.sendMessage(m.jid, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: font.tiny(`${config.BOT_INFO.split(";")[0]}`),
                            sourceUrl: "https://nick.devstackx.in",
                            mediaUrl: "https://nick.devstackx.in",
                            mediaType: 1,
                            showAdAttribution: true,
         ...
         return await client.sendMessage(m.jid, {
                    document: {
                        url: 'https://telegra.ph/file/242fd4b8580dfe60a51dc.jpg'
                    },
                    caption: menu,
